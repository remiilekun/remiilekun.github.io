...
/***/ "../../../../../src/app/task/activetask/activetask.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ActiveTaskComponent; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__typescripts_pro_date_picker_datepicker_component__ = __webpack_require__("../../../../../src/typescripts/pro/date-picker/datepicker.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_task_task__ = __webpack_require__("../../../../../src/app/shared/task/task.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_template_template__ = __webpack_require__("../../../../../src/app/shared/template/template.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_template_template_service__ = __webpack_require__("../../../../../src/app/shared/template/template.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__shared_team_team_stack__ = __webpack_require__("../../../../../src/app/shared/team/team.stack.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__shared_team_team_service__ = __webpack_require__("../../../../../src/app/shared/team/team.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__shared_utility_basic_functions__ = __webpack_require__("../../../../../src/app/shared/utility/basic-functions.ts");
...
var ActiveTaskComponent = (function () {
    function ActiveTaskComponent(taskService, userService, templateService, teamService, teamStack, ref, authService, basicFunctions, router, route) {
        ...
        this.router = router;
        this.route = route;
        this.taskDetails = new __WEBPACK_IMPORTED_MODULE_7__shared_task_task__["a" /* Task */]();
        this.addTask = new __WEBPACK_IMPORTED_MODULE_7__shared_task_task__["a" /* Task */]();
        this.taskForDelete = new __WEBPACK_IMPORTED_MODULE_7__shared_task_task__["a" /* Task */]();
        this.taskForEdit = new __WEBPACK_IMPORTED_MODULE_7__shared_task_task__["a" /* Task */]();
        this.tasks = new __WEBPACK_IMPORTED_MODULE_5_rxjs_BehaviorSubject__["a" /* BehaviorSubject */]([]);
        this.templates = new __WEBPACK_IMPORTED_MODULE_5_rxjs_BehaviorSubject__["a" /* BehaviorSubject */]([]);
        this.options = {};
        this.team = new __WEBPACK_IMPORTED_MODULE_5_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](new __WEBPACK_IMPORTED_MODULE_11__shared_team_team__["a" /* Team */]());
        this.teamLeadName = "";
        this.createTeamId = "";
        this.teamMembers = [];
        this.teamName = "";
        ...
        this.frequency = [];
        this.filteredUsers = [];
        this.assignmentModes = [{ value: "Manual", label: "Manual" }];
        this.templateForTask = new __WEBPACK_IMPORTED_MODULE_8__shared_template_template__["a" /* Template */]();
        this.showDate = false;
        ...
        this.loggedInUserTeams = new Array(new __WEBPACK_IMPORTED_MODULE_11__shared_team_team__["a" /* Team */]());
        this.startDate = "2018-12-12";
    ...
    ActiveTaskComponent.prototype.ngOnInit = function () {
        ...
        this.teamService.loggedInUserTeams.subscribe(function (data) {
            _this.loggedInUserTeams = data;
            if (_this.loggedInUserTeams[0]) {
                _this.addTask.teamId = _this.loggedInUserTeams[0].teamId;
            }
            _this.createTeamId = data[0] ? data[0].teamId : "";
        });
        ...
        this.templateService.templates.subscribe(function (data) {
            _this.templates.next(data.map(function (v) {
                return { label: v.name, value: v.templateId };
            }));
        });
    ...
    ActiveTaskComponent.prototype.ngAfterViewInit = function () { };
    ActiveTaskComponent.prototype.toggleComments = function () {
        this.showComments = !this.showComments;
    };
    ActiveTaskComponent.prototype.log = function ($event) {
        console.log($event);
    };
    // map view
    ActiveTaskComponent.prototype.setCurrentPosition = function () {
        var _this = this;
    ...
    ActiveTaskComponent.prototype.watchPosition = function () {
        var _this = this;
        if ("geolocation" in navigator) {
    ...
    ActiveTaskComponent.prototype.showMap = function () {
        var _this = this;
        this.mapModal.show();
        setTimeout(function () {
            _this.locationMap.triggerResize(false);
    ...
    ActiveTaskComponent.prototype.mapClicked = function ($event) {
        this.marker.lat = $event.coords.lat;
        this.marker.lng = $event.coords.lng;
    };
    ActiveTaskComponent.prototype.markerDragEnd = function ($event) {
        this.marker.lat = $event.coords.lat;
        this.marker.lng = $event.coords.lng;
    };
    ActiveTaskComponent.prototype.getAddress = function () {
        var _this = this;
    ...
    // end map view
    ActiveTaskComponent.prototype.computePrice = function (task) {
    ...
    ActiveTaskComponent.prototype.searchValueChange = function (q) {
        this.searchQuery = q;
        this.taskService.searchTerm.next(this.searchQuery);
    };
    ActiveTaskComponent.prototype.sort = function (q) {
        this.taskService.sortBy(q);
    };
    ActiveTaskComponent.prototype.getUserNameByUserId = function (userId) {
        return this.userService.getUserNameByUserId(userId);
    };
    ActiveTaskComponent.prototype.getCustomerPhoneNumber = function (task) {
        if (task.templateFieldsValues &&
            task.templateFieldsValues.priorTemplate &&
            task.templateFieldsValues.priorTemplate.customerPhoneNumber) {
            return task.templateFieldsValues.priorTemplate.customerPhoneNumber;
        }
        return "N/A";
    };
    ActiveTaskComponent.prototype.getCustomerName = function (task) {
        if (task.templateFieldsValues &&
            task.templateFieldsValues.priorTemplate &&
            task.templateFieldsValues.priorTemplate.customerName) {
            return task.templateFieldsValues.priorTemplate.customerName;
        }
        return "N/A";
    };
    ActiveTaskComponent.prototype.getScheduledTime = function (task, time) {
        if (task.templateFieldsValues && task.templateFieldsValues.priorTemplate) {
            return task.templateFieldsValues.priorTemplate[time] || 0;
        }
        return 0;
    };
    ActiveTaskComponent.prototype.onTemplateChange = function (templateId) {
        this.selectedTemplate = templateId;
        this.options = {};
        var templates = this.templateService.templates.value.filter(function (v) {
            return v.templateId === templateId;
        });
        if (templates.length > 0) {
            this.templateForTask = templates[0];
            this.addTask.template = this.templateForTask;
            this.addTask.template.priorTemplate.map(function (v) {
                v.dropDownValues = v.dropDownValues
                    .map(function (q) {
                    var keys = Object.keys(q);
                    if (keys.length > 0) {
                        return { value: keys[0], label: q[keys[0]] };
                    }
                    else {
                        return {};
                    }
            ...
            this.assignmentModes = this.templateForTask.assignmentMode.map(function (v) {
                return { value: v, label: v };
            });
        }
        this.ref.detectChanges();
    };
    ActiveTaskComponent.prototype.onAssignmentChange = function (assignmentMode) {
    ...
    ActiveTaskComponent.prototype.onAssignedChange = function (assignedTo) {
        if (assignedTo) {
    ...
    ActiveTaskComponent.prototype.onFrequencyChange = function (freq) {
    ...
    ActiveTaskComponent.prototype.onDurationChange = function (dur) {
        switch (dur) {
            case "hours":
    ...
    ActiveTaskComponent.prototype.formatComment = function (comment) {
        return comment.cause + " - " + comment.comment + " -- " + this.convertDateTime(comment.date, "DD MMMM YYYY");
    };
    ActiveTaskComponent.prototype.viewTaskDetails = function (task) {
        this.taskComments = task.comments
            ...
            : [];
        this.showComments = false;
        this.taskDetails = Object.assign(new __WEBPACK_IMPORTED_MODULE_7__shared_task_task__["a" /* Task */](), task);
        this.taskViewModal.show();
        this.ref.detectChanges();
    };
    ActiveTaskComponent.prototype.showNotificationTask = function () {
        var _this = this;
                ...
                var sub_1 = _this.taskService.fetchDone.subscribe(function (data) {
                    if (data) {
                        _this.taskService.getOneTask(refId_1).subscribe(function (taskData) {
                            ...
                            _this.router.navigate(["/home/tasks/active"]);
                        }, function () {
                            if (sub_1) {
                                sub_1.unsubscribe();
                            }
    ...
    ActiveTaskComponent.prototype.generateTaskCards = function (id) {
    ...
    ActiveTaskComponent.prototype.createTask = function (task) {
        var momTime = __WEBPACK_IMPORTED_MODULE_4_moment__("" + this.startTime, ["h:mmA"]).format("HH:mm");
        var SDT = Date.parse(this.startDate + "T" + momTime);
        ...
        task.teamId = task.teamId ? task.teamId : this.createTeamId;
    ...
    ActiveTaskComponent.prototype.closeViewModal = function () {
        var _this = this;
    ...
    ActiveTaskComponent.prototype.closeModal = function () {
        this.taskFormModal.hide();
        this.addTask = new __WEBPACK_IMPORTED_MODULE_7__shared_task_task__["a" /* Task */]();
        this.showDate = false;
        this.startDate = null;
    ...
    ActiveTaskComponent.prototype.confirmDelete = function (task) {
        this.taskForDelete = Object.assign(new __WEBPACK_IMPORTED_MODULE_7__shared_task_task__["a" /* Task */](), task);
        this.taskDeleteModal.show();
    };
    ActiveTaskComponent.prototype.deleteTask = function (task) {
        this.taskService.deleteTask(task);
        this.taskDeleteModal.hide();
        this.taskViewModal.hide();
    };
    ActiveTaskComponent.prototype.convertDateTime = function (dateTime, format) {
        if (dateTime === 0 || dateTime === undefined) {
            return "-";
        }
        return __WEBPACK_IMPORTED_MODULE_4_moment__(new Date(dateTime)).format(format);
    };
    ActiveTaskComponent.prototype.getDropdownArray = function (dropdownValues, i) {
        if (!this.options[i]) {
            this.options[i] = dropdownValues;
        }
    };
    ActiveTaskComponent.prototype.openTaskCreateModal = function () {
        this.taskForm.reset();
        this.taskFormModal.show();
    };
    ActiveTaskComponent.prototype.openEditTaskModal = function (task) {
        var _this = this;
        if (this.checkEditStatus(task)) {
            this.showDuration = false; // under revision
            this.addTask = Object.assign(new __WEBPACK_IMPORTED_MODULE_7__shared_task_task__["a" /* Task */](), task);
            this.selectedTemplate = this.addTask.template.templateId;
            var d = new Date(task.templateFieldsValues.priorTemplate.startDateTime);
            var date_1 = this.basicFunctions.getDateFormat(d, "-");
            if (this.datePicker) {
                setTimeout(function () { return _this.datePicker.onUserDateInput(date_1); }, 0);
            }
            this.startTime = __WEBPACK_IMPORTED_MODULE_4_moment__(task.templateFieldsValues.priorTemplate.startDateTime).format("hh:mmA");
            this.taskFormModal.show();
        }
    };
    ActiveTaskComponent.prototype.checkEditStatus = function (task) {
        if (task.status === "Assigned" &&
            (task.assigner === this.loggedInUser.userId || this.loggedInUser.permissions.corona_web_task_mgt)) {
            return true;
        }
        return false;
    };
    ActiveTaskComponent.prototype.editTask = function (task) {
        if (this.checkEditStatus(task)) {
    ...
    ActiveTaskComponent.prototype.sortBy = function (type) {
        this.order = type;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_12" /* ViewChild */])("taskViewModal"),
        __metadata("design:type", Object)
    ], ActiveTaskComponent.prototype, "taskViewModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_12" /* ViewChild */])("taskFormModal"),
        __metadata("design:type", Object)
    ], ActiveTaskComponent.prototype, "taskFormModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_12" /* ViewChild */])("taskDeleteModal"),
        __metadata("design:type", Object)
    ], ActiveTaskComponent.prototype, "taskDeleteModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_12" /* ViewChild */])("mapModal"),
        __metadata("design:type", Object)
    ], ActiveTaskComponent.prototype, "mapModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_12" /* ViewChild */])("locationInput"),
        __metadata("design:type", Object)
    ], ActiveTaskComponent.prototype, "locationInput", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_12" /* ViewChild */])("locationMap"),
        __metadata("design:type", Object)
    ], ActiveTaskComponent.prototype, "locationMap", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_12" /* ViewChild */])("taskForm"),
        __metadata("design:type", Object)
    ], ActiveTaskComponent.prototype, "taskForm", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_12" /* ViewChild */])("body"),
        __metadata("design:type", Object)
    ], ActiveTaskComponent.prototype, "body", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_12" /* ViewChild */])("datePicker"),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_2__typescripts_pro_date_picker_datepicker_component__["a" /* MDBDatePickerComponent */])
    ], ActiveTaskComponent.prototype, "datePicker", void 0);
    ActiveTaskComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
            selector: "app-tasks",
            template: __webpack_require__("../../../../../src/app/task/activetask/activetask.component.html"),
            styles: [__webpack_require__("../../../../../src/app/task/activetask/activetask.component.scss")],
            changeDetection: __WEBPACK_IMPORTED_MODULE_1__angular_core__["j" /* ChangeDetectionStrategy */].OnPush
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6__shared_task_activetask_service__["a" /* ActiveTaskService */],
            __WEBPACK_IMPORTED_MODULE_10__shared_user_user_service__["a" /* UserService */],
            __WEBPACK_IMPORTED_MODULE_9__shared_template_template_service__["a" /* TemplateService */],
            __WEBPACK_IMPORTED_MODULE_13__shared_team_team_service__["a" /* TeamService */],
            __WEBPACK_IMPORTED_MODULE_12__shared_team_team_stack__["a" /* TeamStack */],
            ...
            __WEBPACK_IMPORTED_MODULE_14__shared_utility_basic_functions__["a" /* BasicFunctions */],
...
/***/ "../../../../../src/app/task/activetask/activetask.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "routes", function() { return routes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActiveTaskModule", function() { return ActiveTaskModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_app_task_activetask_activetask_component__ = __webpack_require__("../../../../../src/app/task/activetask/activetask.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [{ path: "", component: __WEBPACK_IMPORTED_MODULE_3_app_task_activetask_activetask_component__["a" /* ActiveTaskComponent */] }];
var ActiveTaskModule = (function () {
    function ActiveTaskModule() {
    }
    ActiveTaskModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_3_app_task_activetask_activetask_component__["a" /* ActiveTaskComponent */]],
            schemas: [__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NO_ERRORS_SCHEMA */]]
        })
    ], ActiveTaskModule);
    return ActiveTaskModule;
}());
...
//# sourceMappingURL=activetask.module.chunk.js.map