...
/***/ "../../../../../src/app/task/archivedtasks/archivedtasks.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ArchivedTasksComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment__ = __webpack_require__("../../../../moment/moment.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_BehaviorSubject__ = __webpack_require__("../../../../rxjs/_esm5/BehaviorSubject.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_user_auth_service__ = __webpack_require__("../../../../../src/app/shared/user/auth.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_task_archived_task_service__ = __webpack_require__("../../../../../src/app/shared/task/archived-task.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__shared_utility_basic_functions__ = __webpack_require__("../../../../../src/app/shared/utility/basic-functions.ts");
...
var ArchivedTasksComponent = (function () {
    function ArchivedTasksComponent(taskService, userService, teamService, teamStack, authService, ref, basicFunctions, router, route) {
        ...
        this.router = router;
        this.route = route;
        this.taskDetails = new __WEBPACK_IMPORTED_MODULE_6__shared_task_task__["a" /* Task */]();
        this.addTask = new __WEBPACK_IMPORTED_MODULE_6__shared_task_task__["a" /* Task */]();
        this.taskForDelete = new __WEBPACK_IMPORTED_MODULE_6__shared_task_task__["a" /* Task */]();
        this.tasks = new __WEBPACK_IMPORTED_MODULE_2_rxjs_BehaviorSubject__["a" /* BehaviorSubject */]([]);
        this.taskCount = 0;
        this.team = new __WEBPACK_IMPORTED_MODULE_2_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](new __WEBPACK_IMPORTED_MODULE_7__shared_team_team__["a" /* Team */]());
        this.teamLeadName = "";
        this.teamMembers = [];
        this.teamName = "";
    ...
    ArchivedTasksComponent.prototype.toggleComments = function () {
        this.showComments = !this.showComments;
    };
    ArchivedTasksComponent.prototype.formatComment = function (comment) {
        return comment.split("-")[1];
    };
    ArchivedTasksComponent.prototype.showNotificationTask = function () {
        var _this = this;
                ...
                var sub_1 = _this.taskService.fetchDone.subscribe(function (data) {
                    if (data) {
                        _this.taskService.getOneTask(refId_1).subscribe(function (taskData) {
                            ...
                            _this.router.navigate(["/home/tasks/archived"]);
                        }, function () {
                            if (sub_1) {
                                sub_1.unsubscribe();
                            }
    ...
    ArchivedTasksComponent.prototype.generateTaskCards = function (id) {
    ...
    ArchivedTasksComponent.prototype.computePrice = function (task) {
    ...
    ArchivedTasksComponent.prototype.searchValueChange = function (q) {
        this.searchQuery = q;
        this.taskService.searchTerm.next(this.searchQuery);
    };
    ArchivedTasksComponent.prototype.getUserNameByUserId = function (userId) {
        return this.userService.getUserNameByUserId(userId);
    };
    ArchivedTasksComponent.prototype.getCustomerPhoneNumber = function (task) {
    ...
    ArchivedTasksComponent.prototype.getCustomerName = function (task) {
        if (task.templateFieldsValues &&
            task.templateFieldsValues.priorTemplate &&
    ...
    ArchivedTasksComponent.prototype.viewTaskDetails = function (task) {
        this.taskComments =
        ...
        this.showComments = false;
        this.taskDetails = Object.assign(new __WEBPACK_IMPORTED_MODULE_6__shared_task_task__["a" /* Task */](), task);
        this.taskViewModal.show();
    };
    ArchivedTasksComponent.prototype.closeViewModal = function () {
        var _this = this;
    ...
    ArchivedTasksComponent.prototype.convertDateTime = function (dateTime, format) {
        if (dateTime === 0) {
            return "-";
        }
        return __WEBPACK_IMPORTED_MODULE_1_moment__(new Date(dateTime)).format(format);
    };
    ArchivedTasksComponent.prototype.sortBy = function (type) {
        this.order = type;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("taskViewModal"),
        __metadata("design:type", Object)
    ], ArchivedTasksComponent.prototype, "taskViewModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("taskFormModal"),
        __metadata("design:type", Object)
    ], ArchivedTasksComponent.prototype, "taskFormModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("taskDeleteModal"),
        __metadata("design:type", Object)
    ], ArchivedTasksComponent.prototype, "taskDeleteModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("mapModal"),
        __metadata("design:type", Object)
    ], ArchivedTasksComponent.prototype, "mapModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("locationInput"),
        __metadata("design:type", Object)
    ], ArchivedTasksComponent.prototype, "locationInput", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("locationMap"),
        __metadata("design:type", Object)
    ], ArchivedTasksComponent.prototype, "locationMap", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("body"),
        __metadata("design:type", Object)
    ], ArchivedTasksComponent.prototype, "body", void 0);
    ArchivedTasksComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: "app-archivedtasks",
            template: __webpack_require__("../../../../../src/app/task/archivedtasks/archivedtasks.component.html"),
            styles: [__webpack_require__("../../../../../src/app/task/archivedtasks/archivedtasks.component.scss")],
            changeDetection: __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectionStrategy */].OnPush
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__shared_task_archived_task_service__["a" /* ArchivedTaskService */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__shared_user_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["k" /* ChangeDetectorRef */],
            __WEBPACK_IMPORTED_MODULE_11__shared_utility_basic_functions__["a" /* BasicFunctions */],
...
/***/ "../../../../../src/app/task/archivedtasks/archivedtasks.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "routes", function() { return routes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ArchivedTasksModule", function() { return ArchivedTasksModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_app_task_archivedtasks_archivedtasks_component__ = __webpack_require__("../../../../../src/app/task/archivedtasks/archivedtasks.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [{ path: "", component: __WEBPACK_IMPORTED_MODULE_3_app_task_archivedtasks_archivedtasks_component__["a" /* ArchivedTasksComponent */] }];
var ArchivedTasksModule = (function () {
    function ArchivedTasksModule() {
    }
    ArchivedTasksModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_3_app_task_archivedtasks_archivedtasks_component__["a" /* ArchivedTasksComponent */]],
            schemas: [__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NO_ERRORS_SCHEMA */]]
        })
    ], ArchivedTasksModule);
    return ArchivedTasksModule;
}());
...
//# sourceMappingURL=archivedtasks.module.chunk.js.map