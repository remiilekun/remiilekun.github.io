...
/***/ "../../../../../src/app/task/escalatedtasks/escalatedtasks.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EscalatedTasksComponent; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__typescripts_pro_date_picker_datepicker_component__ = __webpack_require__("../../../../../src/typescripts/pro/date-picker/datepicker.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_task_escalated_task_service__ = __webpack_require__("../../../../../src/app/shared/task/escalated-task.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_task_task__ = __webpack_require__("../../../../../src/app/shared/task/task.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_team_team__ = __webpack_require__("../../../../../src/app/shared/team/team.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_team_team_stack__ = __webpack_require__("../../../../../src/app/shared/team/team.stack.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__shared_template_template__ = __webpack_require__("../../../../../src/app/shared/template/template.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__shared_template_template_service__ = __webpack_require__("../../../../../src/app/shared/template/template.service.ts");
...
var EscalatedTasksComponent = (function () {
    function EscalatedTasksComponent(taskService, userService, teamService, templateService, teamStack, authService, ref, basicFunctions, router, route) {
        ...
        this.tasks = new __WEBPACK_IMPORTED_MODULE_3_rxjs_BehaviorSubject__["a" /* BehaviorSubject */]([]);
        this.taskCount = null;
        this.team = new __WEBPACK_IMPORTED_MODULE_3_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](new __WEBPACK_IMPORTED_MODULE_8__shared_team_team__["a" /* Team */]());
        this.teamLeadName = "";
        this.teamMembers = [];
        this.teamName = "";
        ...
        this.templateForTask = new __WEBPACK_IMPORTED_MODULE_12__shared_template_template__["a" /* Template */]();
        this.showDate = false;
    ...
    EscalatedTasksComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    EscalatedTasksComponent.prototype.toggleComments = function () {
        this.showComments = !this.showComments;
    };
    EscalatedTasksComponent.prototype.formatComment = function (comment) {
        return comment.split("-")[1];
    };
    EscalatedTasksComponent.prototype.showNotificationTask = function () {
        var _this = this;
                ...
                var sub_1 = _this.taskService.fetchDone.subscribe(function (data) {
                    if (data) {
                        _this.taskService.getOneTask(refId_1).subscribe(function (taskData) {
                            ...
                            _this.router.navigate(["/home/tasks/escalated"]);
                        }, function () {
                            if (sub_1) {
                                sub_1.unsubscribe();
                            }
    ...
    EscalatedTasksComponent.prototype.generateTaskCards = function (id) {
        if (id === void 0) { id = this.authService.getUserId(); }
        // const sub = this.teamService.getTeamsByLead(id, "escalated").subscribe();
        this.taskService.getDownlineTasks().subscribe();
        this.tasks = this.taskService.downlineTasks;
        // sub.unsubscribe();
    };
    EscalatedTasksComponent.prototype.computePrice = function (task) {
    ...
    EscalatedTasksComponent.prototype.searchValueChange = function (q) {
        this.searchQuery = q;
        this.taskService.searchTerm.next(this.searchQuery);
    };
    EscalatedTasksComponent.prototype.getUserNameByUserId = function (userId) {
        return this.userService.getUserNameByUserId(userId);
    };
    EscalatedTasksComponent.prototype.closeViewModal = function () {
        var _this = this;
    ...
    EscalatedTasksComponent.prototype.viewTaskDetails = function (task) {
        this.taskComments =
    ...
    EscalatedTasksComponent.prototype.confirmDelete = function (task) {
    ...
    EscalatedTasksComponent.prototype.deleteTask = function (task) {
        this.taskService.deleteTask(task);
        this.taskDeleteModal.hide();
        this.taskViewModal.hide();
    };
    EscalatedTasksComponent.prototype.convertDateTime = function (dateTime, format) {
        if (dateTime === 0 || dateTime === undefined) {
            return "-";
        }
        return __WEBPACK_IMPORTED_MODULE_2_moment__(new Date(dateTime)).format(format);
    };
    EscalatedTasksComponent.prototype.reassignTask = function (task, reason, reassign) {
        ...
        this.taskEscalatedReassignModal.hide();
        this.taskService.updateTask(task);
    };
    EscalatedTasksComponent.prototype.reassignTaskPrompt = function (task) {
        var _this = this;
        if (this.checkEditStatus(task)) {
            ...
            this.taskViewModal.hide();
            this.taskEscalatedReassignModal.show();
        }
    };
    EscalatedTasksComponent.prototype.checkEditStatus = function (task) {
        if (task.assigner === this.loggedInUser.userId || this.loggedInUser.permissions.corona_web_task_mgt) {
            return true;
        }
        return false;
    };
    EscalatedTasksComponent.prototype.onAssignedChange = function (assignedTo) {
        if (assignedTo) {
    ...
    EscalatedTasksComponent.prototype.onFrequencyChange = function (freq) {
        switch (freq) {
            case "Anytime":
                this.showDate = false;
            ...
            case "Weekly":
                this.showDate = true;
                this.durationOptions = [{ value: "hours", label: "Hours" }, { value: "days", label: "Days" }];
                break;
            case "Monthly":
                this.showDate = true;
                this.durationOptions = [
    ...
    EscalatedTasksComponent.prototype.onDurationChange = function (dur) {
        switch (dur) {
            case "hours":
    ...
    // map view
    EscalatedTasksComponent.prototype.setCurrentPosition = function () {
        var _this = this;
    ...
    EscalatedTasksComponent.prototype.watchPosition = function () {
        var _this = this;
        if ("geolocation" in navigator) {
    ...
    EscalatedTasksComponent.prototype.showMap = function () {
        var _this = this;
        this.mapModal.show();
        setTimeout(function () {
            _this.locationMap.triggerResize(false);
    ...
    EscalatedTasksComponent.prototype.mapClicked = function ($event) {
        this.marker.lat = $event.coords.lat;
        this.marker.lng = $event.coords.lng;
    };
    EscalatedTasksComponent.prototype.markerDragEnd = function ($event) {
        this.marker.lat = $event.coords.lat;
        this.marker.lng = $event.coords.lng;
    };
    EscalatedTasksComponent.prototype.getAddress = function () {
        var _this = this;
    ...
    // end map view
    EscalatedTasksComponent.prototype.sortBy = function (type) {
        this.order = type;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("taskEscalatedReassignModal"),
        __metadata("design:type", Object)
    ], EscalatedTasksComponent.prototype, "taskEscalatedReassignModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("taskViewModal"),
        __metadata("design:type", Object)
    ], EscalatedTasksComponent.prototype, "taskViewModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("taskFormModal"),
        __metadata("design:type", Object)
    ], EscalatedTasksComponent.prototype, "taskFormModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("taskDeleteModal"),
        __metadata("design:type", Object)
    ], EscalatedTasksComponent.prototype, "taskDeleteModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("taskForm"),
        __metadata("design:type", Object)
    ], EscalatedTasksComponent.prototype, "taskForm", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("mapModal"),
        __metadata("design:type", Object)
    ], EscalatedTasksComponent.prototype, "mapModal", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("locationInput"),
        __metadata("design:type", Object)
    ], EscalatedTasksComponent.prototype, "locationInput", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("locationMap"),
        __metadata("design:type", Object)
    ], EscalatedTasksComponent.prototype, "locationMap", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("body"),
        __metadata("design:type", Object)
    ], EscalatedTasksComponent.prototype, "body", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])("datePicker"),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_4__typescripts_pro_date_picker_datepicker_component__["a" /* MDBDatePickerComponent */])
    ], EscalatedTasksComponent.prototype, "datePicker", void 0);
    EscalatedTasksComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: "app-escalatedtasks",
            template: __webpack_require__("../../../../../src/app/task/escalatedtasks/escalatedtasks.component.html"),
            styles: [__webpack_require__("../../../../../src/app/task/escalatedtasks/escalatedtasks.component.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6__shared_task_escalated_task_service__["a" /* EscalatedTaskService */],
            ...
            __WEBPACK_IMPORTED_MODULE_13__shared_template_template_service__["a" /* TemplateService */],
            __WEBPACK_IMPORTED_MODULE_9__shared_team_team_stack__["a" /* TeamStack */],
    ...
    return EscalatedTasksComponent;
}());
...
/***/ "../../../../../src/app/task/escalatedtasks/escalatedtasks.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "routes", function() { return routes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EscalatedTasksModule", function() { return EscalatedTasksModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_app_task_escalatedtasks_escalatedtasks_component__ = __webpack_require__("../../../../../src/app/task/escalatedtasks/escalatedtasks.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [{ path: "", component: __WEBPACK_IMPORTED_MODULE_3_app_task_escalatedtasks_escalatedtasks_component__["a" /* EscalatedTasksComponent */] }];
var EscalatedTasksModule = (function () {
    function EscalatedTasksModule() {
    }
    EscalatedTasksModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_3_app_task_escalatedtasks_escalatedtasks_component__["a" /* EscalatedTasksComponent */]],
            schemas: [__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NO_ERRORS_SCHEMA */]]
        })
    ], EscalatedTasksModule);
    return EscalatedTasksModule;
}());
...
//# sourceMappingURL=escalatedtasks.module.chunk.js.map